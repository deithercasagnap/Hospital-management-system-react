  ...
  return (
    ...
    <>
      ...
      <div id='aboutus' className='mb-[4rem] mt-[2rem] '>
        ...
        <h6 className='text-blueColor text-center text-[20px] border-b-[1px] py-[1rem] w-[550px] pb-[10px] block ms-8'>
        ...
        <div className='grid gap-4 grid-cols-2 text-end leading-10 items-center ms-[80px] '>
          ...
          <div className='flex justify-center'> 
            <img src={logo1} alt="" className=' rounded-full items-center h-[300px] w-[300px]'/>
          </div>
